              ...
              {/* <Button onClick={() => setOpenModal(true)}>Toggle modal</Button> */}
                ...
                <Modal show={openModal} size="md" position="center" onClose={() => setOpenModal(false)}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                          <Checkbox id="accept" />
                          <Label htmlFor="accept">By clicking Share, you are authorizing this institution(s) to have access of your <a rel="noopener noreferer"href="#/" className='font-bold'>Official transcript </a> and PII. </Label>
                        </div>
                    </div>
                    </Modal.Body>
                    <Modal.Footer>
                ...
                <Modal show={confirmModal} size="md" position="center" onClose={() => setConfirmModal(false)}>
                    ...
                    <p className=''> You can track the transcript status on the <a rel="noopener noreferer"href="#/" className='text-purple'> Military Transcript</a>. </p>
                    </div>
                    </Modal.Body>
                    <Modal.Footer>
                ...
                <GraySecondaryButton buttonLabel={"View Transcript"} route={"/"} 
                icon={<>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg> </>} />
                <GraySecondaryButton buttonLabel={"Download Transcript (PDF)"} route={"/"} 
                icon={<>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
