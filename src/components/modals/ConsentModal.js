...
export default function ConsentModal() {
  ...
  const handleDecline = () => {
    // need to implement something when user choose to decline the consent
    // as of now, redirect to 403 forbidden page (404 actually as 403 is not implemented)
    router.push('/403');
        ...
        <div className="text-center">
          ...
          <div className="mb-5">
            <Label>
              ...
              <span className="ml-2">
                I have read and agree to the <a href="/#" className="text-blue-500">Privacy Policy</a>
              </span>
            </Label>
          </div>
