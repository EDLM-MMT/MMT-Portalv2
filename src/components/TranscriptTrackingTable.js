        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mb-8">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-4 py-3">Send To</th>
                            <th scope="col" className="px-4 py-3">Send Date</th>
                            <th scope="col" className="px-4 py-3">Status</th>
                            <th scope="col" className="px-4 py-3">Download Date</th>
                        ...
                        {data.map((data, index) => {
                            return (
                                <tr className="border-b dark:border-gray-700" key={data.sentTo}>
                                    ...
                                    <td className="px-4 py-3">{data.sentTo}</td>
                                    <td className="px-4 py-3">{data.sendDate}</td>
                                    ...
                                    <td className="px-4 py-3">{data.action}</td>
                                </tr>
                            )
                        })}
            ...
            <nav className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                ...
                <ul className="inline-flex items-stretch -space-x-px">
                    ...
                    <li>
                        <a rel="noopener noreferer"href="/#" className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">6</a>
                    </li>
                    <li>
