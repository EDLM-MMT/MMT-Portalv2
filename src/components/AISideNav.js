      ...
      <>
        <div className="flex h-lvh flex-col py-2 w-72 bg-white">
          ...
          <div className='flex flex-col m-4 pl-2 gap-4' >
            <a rel="noopener noreferer"className="flex flex-row gap-4 hover:cursor hover:font-bold hover:underline" href="/academicInstitute">
              <DocumentTextIcon className="h-6 mt-2"/>
              Modernized Military Transcript 
            </a>
            <a rel="noopener noreferer"className="flex flex-row gap-4 hover:cursor hover:font-bold hover:underline" href="/academicInstitute/userManagement">
              <UserGroupIcon className="h-5 mt-1"/>
              User Management
            </a>
            <a rel="noopener noreferer"className="flex flex-row gap-4 hover:cursor hover:font-bold hover:underline" href="/academicInstitute/help">
